 ...
 */
@WebServlet("/AbsenceByDate/List")
public class AbsenceListByDate extends HttpServlet{
	private static final long serialVersionUID = 1L;
	private AbsenceDAO absencedao;
	public AbsenceListByDate() {
	...
	try {
		Date date=(Date) new SimpleDateFormat("dd/MM/yyyy").parse(request.getParameter("date"));
	...
	out.flush();
	*/
		absetd=AbsenceDAO.getAllByFil(id);
		response.setContentType("application/json");
		response.setCharacterEncoding("UTF-8");
