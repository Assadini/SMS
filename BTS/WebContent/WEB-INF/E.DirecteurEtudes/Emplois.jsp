	...
	<div class="container"> 
		...
		<div class="col-md-9"> <!-- Col 1 -->
			<div class="alert bg-light text-secondary" role="alert">
	   			...
	   			Classes: <select id="cll" name="cll" class="form-control"></select>
			...
			<table  class="table table-striped table-bordered rounded mt-5" cellspacing="0" width="100%">
				...
				<tbody>
				<tr>
						<th class="bg-warning text-center">LUNDI</th>
					...
					<tr>
						<th class="bg-warning text-center">MARDI</th>
					...
					<tr>
						<th class="bg-warning text-center">MERCREDI</th>
					...
					<tr>
						<th class="bg-warning text-center">JEUDI</th>
					...
					<tr>
						<th class="bg-warning text-center">VENDREDI</th>
					...
					<tr>
						<th class="bg-warning text-center">SAMEDI</th>
				      	...
				      	<div class="modal-content shadow-lg p-3 mb-5 bg-white rounded">
				          	...
				          	<div class="modal-body">
				          		<div class="form-group row">
						    		<label for="cl" class="col-sm-3 control-label">Classe</label>
								    <div class="col-sm-9">
								      <select id="cl" class="form-control" name="classe"  required>
								      </select>
								    </div>
						  		</div>
								<div class="form-group row">
								  ...
								  <div class="col-sm-9">
								    <select id="mod" class="form-control" name="module" required>
								    </select>
								  </div>
								</div>
								<div class="form-group row">
								...
								<div class="form-group row">
								  ...
								  <div class="col-sm-9">
								    <input id="duree"  type="text" class="form-control" name="duree"  />
								  </div>
								</div>
  	...
  	$(document).ready(function() {
		...
		/*******************Fin : Ajax Load Animation *************************/
  		...
  		/************** DataTable du Tab : Classes **************/
				...
				$.ajax({
					...
					success: function(response,textStatus ,jqXHR){
						...
						for(i=0;i<response.length;i++){
							...
							$("#"+response[i].jour+"_"+ response[i].heureDebut+"_"+response[i].heureFin).text(response[i].professeur.nom_Fr+"\t|\t"+response[i].matiere.nom_Fr+"      "+response[i].salle.code);
			...
			//Chargement des Classes dans list déroulante id=cll
			loadClasses();
			//=============================================
				$("#cll").change(function(){
					loadTAHA();
			...
			//========================================================================
  			...
  			/********** Gestion form ajout séance **********************/
  		
  			$("#hf").change(function(){
  				diff= parseInt($("#hf").val())-parseInt($("#hd").val());
				$("#ds").val(diff);
  			});
  			$("#hd").change(function(){
  				var deb=new Array("8 H","9 H","10 H","11 H"," 12 H"," 14 H","15 H","16 H","17 H");
  				var fin=new Array("9 H","10 H","11 H","12 H"," 14 H"," 15 H","16 H","17 H","18 H");
  				var vhd=parseInt($("#hd").val());
  				for(var i=0;i<deb.length;i++)
  					{
  					if(vhd==parseInt(deb[i])) break;
  					}
				...
				for(j=i;j<fin.length;j++){
					if(j<=3 ){
					var item  ='<option value="'+fin[j]+'">'+fin[j]+'</option>';
					$("#hf").append(item);    
					}}}
  				if(i>3 ){
  					for(j=i;j<fin.length;j++){
