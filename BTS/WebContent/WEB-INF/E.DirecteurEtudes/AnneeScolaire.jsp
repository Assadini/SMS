												...
												<form id="anneeScolaire_Add_Form" method="POST" action="../AnneeScolaire/Add" autocomplete="off" >
											      	<div class="modal-content shadow-lg p-3 mb-5 bg-white rounded">
											          	...
											          	<div class="modal-body">
											          		<div class="form-group row">
													    		<label for="anneeScolaire_code" class="col-sm-3 control-label">Nom</label>
															    <div class="col-sm-9">
															      <input id="anneeScolaire_code" type="text" class="form-control" name="code" placeholder="Nom de l'etudiant"/ required>
															    </div>
													  		</div>
															<div class="form-group row">
															  <label for="anneeScolaire_Date_Debut" class="col-sm-3 control-label">Date de l'absence</label>
															  <div class="col-sm-9">
															    <input id="anneeScolaire_Date_Debut" type="date" class="form-control text-field" name="dateDebut" required/>
															  </div>
															</div>
													  		<div class="form-group row">
															  <label for="anneeScolaire_Date_Fin" class="col-sm-3 control-label">Heure de l'absence</label>
															  <div class="col-sm-9">
															    <input id="anneeScolaire_Date_Fin" type="time" class="form-control" name="dateFin" required/>
															  </div>
															</div>
											      	</div>
