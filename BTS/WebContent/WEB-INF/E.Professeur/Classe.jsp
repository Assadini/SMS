						...
						var btns='<div class="btn-group dropleft"> \
							  ...
							  <div class="dropdown-menu shadow p-3 mb-5 bg-white rounded" id="dropdownCycle"> \
						        ...
						        <div class="dropdown-divider"></div> \
							  	...
							  	<a class="dropdown-item classeGenerique-programme text-primary" href="${pageContext.request.contextPath}/E.Professeur/Absence" onclick="sessionStorage.param1='+response[i].id+'" classeGeneriqueId="'+response[i].id+'"><span class="fa fa-cog mr-4"></span>Absence</a> \
							  </div> \
							</div> ';
						tableData.row.add( [
						             rang,
			...
			**************************************************************************/
			...
			$.ajax({
				...
				success: function(response,textStatus ,jqXHR){
					...
					var descriptionItem ='<li class="list-group-item"><span><strong>Description	</strong></span><span class="float-right">'+response.classeGenerique.description+'</span></li>';
